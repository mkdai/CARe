...
// const timekitApp = process.env.timekitApp;
// const timekitEmail = process.env.timekitEmail;
// const timekitPassword = process.env.timekitEmail;
const { timekitApp, timekitEmail, timekitPassword } =
  process.env || require("../env/config.js");
